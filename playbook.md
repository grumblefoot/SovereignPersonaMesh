...
| 2026-08-26 | AUDIT | LOGGED | Documented 8 reported defects and feature requests in [known_issues.md](file:///home/osmon/Desktop/Experiments/SillyTavern/SovereignPersistanceMesh/known_issues.md) from Arvenia multi-turn testing (BUG-001 through BUG-008 & FEAT-006: Session ID fallback, Thought Stream SSE live updates, character stream labeling, Vibe Profiler gauges, Spatial Map rendering, RAG Score Inspector, Factory Reset trigger, and Multi-Session Subtabs). |
